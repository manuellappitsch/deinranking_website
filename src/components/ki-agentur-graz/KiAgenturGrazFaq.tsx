...
export function KiAgenturGrazFaq() {
    const { faq } = siteConfig.content.kiAgenturGraz;
        ...
        <section className="py-20 md:py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg">Alles Wichtige zur KI Agentur Graz und unseren Leistungen.</p>
                </motion.div>
